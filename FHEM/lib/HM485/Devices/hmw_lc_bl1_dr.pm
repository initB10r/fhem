				...
				"paramset" => {
					...
					"master" => {
						...
						},
						{
							...
							"id" => "reference_running_time_bottom_top",
							"logical" => {
								"default" => 50.0,
								"max" => 6000.0,
								"min" => 0.1,
						...
						},
						{
							...
							"id" => "reference_running_time_top_bottom",
							"logical" => {
								"default" => 50.0,
								"max" => 6000.0,
								"min" => 0.1,
